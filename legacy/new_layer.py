...
__all__ = ['SAGEConvMLP', 'GCNConvMLP', 'GINConvMLP', "ChebConvMLP", "GATConvMLP",
           "SAGEConv", "GCNConv", "GINConv", "CuGraphSAGEConv", "ChebConv", "GATConv"]
...
from torch_geometric.nn import (SAGEConv, GCNConv, GATConv, GINConv, ChebConv,
                                MessagePassing)
...
if __name__ == "__main__":
    ...
    a = GATConvMLP(conv=GATConv(16, 32, heads=4, concat=False, bias=False, residual=True))
